      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {servicesData.map((service, index) => (
            <div
              key={index}
              className="relative w-full flex justify-between items-center mb-45px transition duration-300 bg-white shadow-md xl:p-6 lg:p-4 rounded-lg"
            >
              <div className="relative w-[60px] text-blue-600 pr-8">
                <div className=" text-blue-600 text-3xl md:text-4xl lg:text-4xl xl:text-4xl leading-60px mt-5">
                  {service.icon}
                </div>
              </div>
